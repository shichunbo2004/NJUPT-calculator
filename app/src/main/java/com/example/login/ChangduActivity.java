  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btAdd.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Intent intent=new Intent(ChangduActivity.this,AddChangduActivity.class);
    ...
    btExchange.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (TextUtils.isEmpty(etExchangeQuantity.getText().toString())){
          Toast.makeText(ChangduActivity.this,"请添加换算数量",Toast.LENGTH_SHORT).show();
          return;
        }
        ...
        if (!changduDao.isExist(sp1.getSelectedItem().toString(),sp2.getSelectedItem().toString())) {
          Toast.makeText(ChangduActivity.this,"请添加换算关系",Toast.LENGTH_SHORT).show();
        }else {
           ArrayList<ExchangeBean> value = changduDao.findValue(sp1.getSelectedItem().toString(), sp2.getSelectedItem().toString());
