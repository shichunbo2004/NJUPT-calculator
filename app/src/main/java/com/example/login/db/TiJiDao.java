...
public class TiJiDao {
  ...
  public ArrayList<ExchangeBean> findValue(String unit1, String unit2) {
    ...
    Cursor cursor = db.query("Tiji", null, "unit1 = ? and unit2 = ? ", new String[] {unit1,unit2}, null, null, null);
