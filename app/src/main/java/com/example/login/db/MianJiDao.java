...
public class MianJiDao {
  ...
  public ArrayList<ExchangeBean> findValue(String unit1, String unit2) {
    ...
    Cursor cursor = db.query("Mianji", null, "unit1 = ? and unit2 = ? ", new String[] {unit1,unit2}, null, null, null);
