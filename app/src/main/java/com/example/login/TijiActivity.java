  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btAdd.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Intent intent=new Intent(TijiActivity.this,AddTijiActivity.class);
    ...
    btExchange.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if (TextUtils.isEmpty(etExchangeQuantity.getText().toString())){
          Toast.makeText(TijiActivity.this,"请添加换算数量",Toast.LENGTH_SHORT).show();
          return;
        }
        ...
        if (!tiJiDao.isExist(sp1.getSelectedItem().toString(),sp2.getSelectedItem().toString())) {
          Toast.makeText(TijiActivity.this,"请添加换算关系",Toast.LENGTH_SHORT).show();
        }else {
          ArrayList<ExchangeBean> value = tiJiDao.findValue(sp1.getSelectedItem().toString(), sp2.getSelectedItem().toString());
